...
# Criando tabela
table = PrettyTable()
table.field_names = ["#", "Jogadores", "Posição", "Idade", "Nacionalidade", "Origem", "Valor de Mercado (na época)", "Valor Pago"]
...
for jogador in jogadores:
    ...
    if len(dados_jogador) >= 9:  # Verifica se existem dados suficientes
        ...
        table.add_row([num, nome, posicao, idade, nacionalidade + nacionalidade2, origem, valorJogador, valorPago])
